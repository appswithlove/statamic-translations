...
return [
    ...
    */
    ...
    'custom' => [  // 
        'attribute-name' => [  // 
            'rule-name' => 'Benutzerdefinierte Nachricht',  // 'custom-message'
        ],
        'fields' => [  // 
            'username' => [  // 
                'not_in' => 'Gewählter Benutzername ist bereits vergeben.',  // 'The selected username is taken.'
            ],
            'email' => [  // 
                'not_in' => 'Gewählte E-Mail Adresse ist bereits vergeben.',  // 'The selected email is taken.'
            ]
        ]
    ],
